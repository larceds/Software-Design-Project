...
public class SDFINALSGRADESSTUDENTS extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SDFINALSGRADESSTUDENTS frame = new SDFINALSGRADESSTUDENTS();
	...
	public SDFINALSGRADESSTUDENTS() {
		...
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\Tejada\\Downloads\\435133161_895575675912113_4997662471419241260_n.png"));

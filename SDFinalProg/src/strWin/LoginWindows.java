...
;
	...
	private void initialize() {
		...
		Username.setBounds(41, 127, 548, 30);
...
//  This makes read the database in sql
			@Override
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String localhost = "Select * from studentsdata where UserName='"+Username.getText()+"'and Password='"+String.valueOf(password.getPassword())+"'";

...
public class ProfessorProfile extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProfessorProfile frame = new ProfessorProfile();
	...
	public ProfessorProfile() {
		...
		lblNewLabel_1.setIcon(new ImageIcon("F:\\Eclipse\\Barzaga\\Background\\topback.jpg"));
		lblNewLabel_1.setBounds(0, 0, 975, 68);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Brian Kent B\\OneDrive\\Documents\\put pic.jpg"));
		lblNewLabel.setBounds(753, 136, 101, 102);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setBackground(new Color(255, 128, 128));
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\Brian Kent B\\OneDrive\\Documents\\iconpic.jpg"));
		...
		lblNewLabel_15.setIcon(new ImageIcon("C:\\Users\\Brian Kent B\\OneDrive\\Documents\\7.png"));
		lblNewLabel_15.setBounds(0, 67, 975, 41);
		contentPane.add(lblNewLabel_15);
		
		JLabel lblNewLabel_16 = new JLabel("New label");
		lblNewLabel_16.setIcon(new ImageIcon("F:\\bottom.jpg"));
		lblNewLabel_16.setBounds(-285, 515, 1274, 56);
		contentPane.add(lblNewLabel_16);
		
		JLabel lblNewLabel_17 = new JLabel("New label");
		lblNewLabel_17.setIcon(new ImageIcon("F:\\Eclipse\\Barzaga\\Background\\background.png"));
